  ...
  return (
    <header className={headerClassName}>
      <div className="container">
        ...
        {/* Tombol CTA juga menandai halaman yang sedang dibuka. Sejak isinya
            berpindah dari /kontak ke sebuah halaman berisi, ia bukan lagi
            sekadar aksi keluar: ia salah satu tujuan navigasi. */}
        <Link
          href={settings.headerCtaHref}
          className={activeHref === settings.headerCtaHref ? 'hdr-cta active' : 'hdr-cta'}
          aria-current={activeHref === settings.headerCtaHref ? 'page' : undefined}
          onClick={closeAll}
        >
